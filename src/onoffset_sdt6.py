...
from modules_sdt6 import SDT6Classifier
from train_modules.train_sdt6 import train_sdt6_4loss
...
if PRESENT_FILE == 1 and PRESENT_EPOCH == 0:
    ...
    if on_NORM_LAYER == "bn" or on_NORM_LAYER == "bb" or on_NORM_LAYER == "bl":
        ...
        on_note_decoder = SDT6Classifier(INPUT_SIZE1, OUTPUT_SIZE, on_HIDDEN_SIZE, on_HIDDEN_LAYER, BATCH_SIZE, 2*WINDOW_SIZE+1, on_BIDIR)
    else:
    ...
    on_note_encoder.load_state_dict(torch.load(on_enc_model_train_file))
...
for epoch in range(EPOCH):
    ...
    for step, xys in enumerate(train_loader):                 # gives batch data
        ...
        #loss = train_sdt6(b_x1, b_y1, note_encoders, note_decoders, enc_optimizers, dec_optimizers, loss_funcs,
        #    INPUT_SIZE1, OUTPUT_SIZE, BATCH_SIZE, k=WINDOW_SIZE)
        loss = train_sdt6_4loss(b_x1, b_y1, note_encoders, note_decoders, enc_optimizers, dec_optimizers, loss_funcs,
            INPUT_SIZE1, OUTPUT_SIZE, BATCH_SIZE, k=WINDOW_SIZE)
