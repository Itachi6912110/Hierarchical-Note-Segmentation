...
MDIR="model/sdt6_4loss_${NORM}${WS}_l${HL1}h${HS1}b${BIDIR1}_e${END_EPOCH}b${BATCH}_${FEAT1}_sample"
...
LFILE="loss/sdt6_4loss_onoffset_attn_${NORM}${WS}_l${HL1}h${HS1}b${BIDIR1}_e${END_EPOCH}b${BATCH}_${FEAT1}_sample.csv"
...
do
    for num in $(seq 1 82)
    do
        python3 src/onoffset_sdt6.py -d1 ${DHEAD}${num}_${FEAT1} -a1 ${AHEAD1}${num} -em1 ${EMFILE1} \
