...
wget --no-check-certificate "https://drive.google.com/uc?export=download&id=1HkOSutpUS_6Gx5Zic3SeQBbcSpBl-iKD" -O data/TONAS_note.zip
wget --no-check-certificate "https://drive.google.com/uc?export=download&id=12caWqjm_Wnaa50HOfR1wOYUtr7E4IW5M" -O data/ISMIR2014_note.zip
